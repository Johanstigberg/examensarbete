...
const pokeballIndicatorsContainer = document.getElementById("pokeball-indicators");
...
function updatePokeballIndicators() {
    pokeballIndicatorsContainer.innerHTML = '';
    ...
    for (let i = 0; i < remainingPokemonCount; i++) { 
        ...
        pokeballImg.src = 'bilder/Pokeball.png'; 
